    ...
    NavHost(navController = navController, startDestination = AppsScreens.MusicianHomeScreen.route) {
        composable(route = AppsScreens.MusicianHomeScreen.route) {
            ...
            UserHomeScreen(
                ...
                onOpenMySongs = {
                    navigateFromBottomBar(AppsScreens.MusicianMySongsScreen.route)
                },
                onOpenTeam = {
        ...
        composable(route = AppsScreens.MusicianMySongsScreen.route) {
            val viewModel: UserSongsViewModel = viewModel()
            LaunchedEffect(viewModel) {
        ...
        composable(route = AppsScreens.MusicianTeamScreen.route) {
            UserTeamScreen(
                ...
                onOpenMySongs = { navigateFromBottomBar(AppsScreens.MusicianMySongsScreen.route) },
